# Generated by Django 4.0.4 on 2022-05-07 17:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover', models.ImageField(null=True, upload_to=core.models.cover_image_file_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='books', related_query_name='book', to='core.book')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='book',
            name='genre',
            field=models.ManyToManyField(related_name='books', related_query_name='book', to='core.genre'),
        ),
        migrations.AddField(
            model_name='book',
            name='publishing_house',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.publishinghouse'),
        ),
        migrations.CreateModel(
            name='User',
            fields=[
